...
label chpt1_1:
    ...
    #{显示立绘 ZZ12ys}
    show ZZ 11ys at middle with dissolve
    #{播放vioce 2001}
    Zhizi "あ、すみません。（对不起。）"
    "耳边突然传来了熟悉的声音。"
    ...
    show WH 13jy at right with dissolve:
        xoffset -200
    me "と、ともこちゃん？（智子？）"
...
label chpt1_choice_1B:
    #选择B.
    #好感度参数 +10
    #{显示立绘 WH13ng}
    show WH 13ng at middle with dissolve
    me "我来给智子做介绍吧。这时候应该怎么说呢？"

    jump chpt1_3

label chpt1_choice_1A:
    #选择A.
    #{显示立绘 WH13ng}
    show WH 13ng at middle with dissolve
...
label chpt1_4:
    ...
    "一旁的周小雨露出了万分惊讶的表情。"
    #{显示立绘 XY11jy}
    show XY 11jy at middle with dissolve
    #{播放vioce 2017}
    ...
    #{显示立绘 XY12cx}
    show WH at MidToRight
    show XY 12cx at left with dissolve
    #{播放vioce 2025}
